...
const DottedGlowBackground = memo(function DottedGlowBackground({
  className,
}: {
  className?: string;
}) {
...
function FlippingEmail({ email }: { email: string }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div className="font-nohemi text-lg md:text-xl text-white/60 hover:text-white transition-colors backface-hidden">
          Email Me →
        </div>
        {/* Back */}
        <div
    ...
    <footer id="contact" className="relative w-full bg-black">
      ...
      <div className="swiss-container relative z-10 py-20 md:py-32">
        <div className="flex flex-col items-center justify-center text-center w-full">
          ...
          <h2
            className="font-harmond text-[15vw] sm:text-[12vw] md:text-[10vw] lg:text-[12vw] font-bold tracking-tight text-white leading-[0.8] mb-8"
            style={{
              textShadow:
                "0 0 100px rgba(59,130,246,0.3), 0 0 200px rgba(139,92,246,0.2)",
            }}
          >
            LET&apos;S
            <br />
          ...
          <MagneticButton
            as="a"
            href="mailto:ajibolajuwon5@gmail.com"
            strength={0.4}
            className="group"
          >
            <span
          ...
          {/* Email flip */}
          <div className="mt-12">
            <FlippingEmail email="ajibolajuwon5@gmail.com" />
          </div>
        ...
        <div className="swiss-container">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            <p className="font-nohemi text-xs text-white/40">
              © {new Date().getFullYear()} JayCode. All rights reserved.
            </p>
            <p className="font-nohemi text-xs text-white/40">
              GitHub: Juwonthefirst | Built with ♥ and lots of ☕
            </p>
            <p className="font-nohemi text-xs text-white/40">
              Inspired and Designed by: dev-sufyaan
            </p>
          </div>
        </div>
      </div>
